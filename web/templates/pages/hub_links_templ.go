...
func HubLinks(userInfo *oidc.UserInfo, hub *ent.Hub, links []*ent.Link) templ.Component {
...
func hubLinksPage(hub *ent.Hub, links []*ent.Link) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/pages/hub_links.templ`, Line: 43, Col: 88}
		}
