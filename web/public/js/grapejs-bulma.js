// source of the not edited version : https://github.com/juancarlospaco/grabulma

function BulmaBlocks(editor) {
  /* Bulma Templates *********************************************************/

  editor.Blocks.add("bulma_templates_hero", {
    label: "Hero 4 links",
    content: `
      <section class="hero">
        <div class="hero-body">
    ...
    category: "Bulma - Templates",
    media:
      '<img src="https://bulma.io/favicons/favicon-32x32.png" height=32 width=32 loading="lazy">',
  });

  editor.Blocks.add("bulma_templates_section", {
  ...
  editor.Blocks.add("bulma_templates_team", {
    label: "Meet the Team",
    content: `
      <section class="section">
  ...
  editor.Blocks.add("bulma_templates_pricing", {
    label: "Pricing Plans",
    content: `
      <section class="section">
        <div class="container has-text-centered py-4">
  ...
  editor.Blocks.add("bulma_templates_faq", {
    label: "FAQ",
    content: `
      <section class="section">
        <div class="container py-4">
  ...
  editor.Blocks.add("bulma_templates_contact", {
    label: "Contact form",
    content: `
      <section class="section">
        <div class="container py-4">
  ...
  editor.Blocks.add("bulma_templates_contact2", {
  ...
  editor.Blocks.add("bulma_templates_learn", {
    label: "Learn More",
    content: `
      <section class="section">
  ...
  editor.Blocks.add("bulma_templates_how", {
    label: "How it Works",
    content: `
      <section class="section">
        <div class="container has-text-centered py-4">
  ...
  editor.Blocks.add("bulma_templates_features", {
  ...
  editor.Blocks.add("bulma_tiles_0", {
    label: "Tiles 0",
    content: `
  ...
  editor.Blocks.add("bulma_tiles_1", {
    label: "Tiles 1",
    content: `
      <div class="tile is-ancestor">
        <div class="tile is-parent">
  ...
  editor.Blocks.add("bulma_heros_gradient", {
    label: "Hero Gradient",
    content: `
  ...
  editor.Blocks.add("bulma_heros_big", {
    label: "Hero Big Full",
    content: `
  ...
  editor.Blocks.add("bulma_cards_image", {
    label: "Cards Image",
    content: `
    <div class="card">
  ...
  editor.Blocks.add("bulma_cards_text", {
    label: "Cards Text",
    content: `
    <div class="card">
  ...
  editor.Blocks.add("bulma_boxes_image", {
    label: "Box Image",
    content: `
    <div class="box">
      <article class="media">
  ...
  editor.Blocks.add("bulma_boxes_text", {
    label: "Box Text",
    content: `
    <div class="box">
      <div class="content">
  ...
  editor.Blocks.add("bulma_buttons_grouped", {
  ...
  editor.Blocks.add("bulma_buttons_addons", {
  ...
  editor.Blocks.add("bulma_buttons_grid", {
  ...
  editor.Blocks.add("bulma_buttons_list", {
    label: "Buttons List",
    content: `
    <div class="buttons">
  ...
  editor.Blocks.add("bulma_buttons_big", {
  ...
  editor.Blocks.add("bulma_buttons_small", {
  ...
  editor.Blocks.add("bulma_panels_0", {
    label: "Panels 0",
    content: `
  ...
  editor.Blocks.add("bulma_panels_1", {
    label: "Panels 1",
    content: `
  ...
  editor.Blocks.add("bulma_modals_card", {
  ...
  editor.Blocks.add("bulma_modals_image", {
  ...
  editor.Blocks.add("bulma_messages_simple", {
  ...
  editor.Blocks.add("bulma_messages_small", {
    label: "Message Small",
    content: `
  ...
  editor.Blocks.add("bulma_menus_big", {
    label: "Menu Big",
    content: `
    <aside class="menu">
      <p class="menu-label">
  ...
  editor.Blocks.add("bulma_menus_small", {
    label: "Menu Small",
    content: `
    <aside class="menu">
      <p class="menu-label">
  ...
  editor.Blocks.add("bulma_dropdowns_hoverable", {
  ...
  editor.Blocks.add("bulma_dropdowns_dropup", {
  ...
  editor.Blocks.add("bulma_breadcrumbs_small", {
  ...
  editor.Blocks.add("bulma_breadcrumbs_big", {
  ...
  editor.Blocks.add("bulma_tags_simple", {
    label: "Tags",
    content: `
  ...
  editor.Blocks.add("bulma_tags_rounded", {
    label: "Tags Rounded",
    content: `
    <div class="field is-grouped is-grouped-multiline">
  ...
  editor.Blocks.add("bulma_tables_scrollable", {
  ...
  editor.Blocks.add("bulma_tables_fullwidth", {
  ...
  editor.Blocks.add("bulma_progress_small", {
  ...
  editor.Blocks.add("bulma_notifications_simple", {
  ...
  editor.Blocks.add("bulma_notifications_light", {
  ...
  editor.Blocks.add("bulma_files_small", {
    label: "Files small",
    content: `
  ...
  editor.Blocks.add("bulma_files_centered", {
  ...
  editor.Blocks.add("bulma_selects_multiple", {
  ...
  editor.Blocks.add("bulma_selects_simple", {
    label: "Select Simple",
    content: `
    <div class="field">
  ...
  editor.Blocks.add("bulma_footers_simple", {
    label: "Footer Simple",
    content: `
    <footer class="footer">
  ...
  editor.Blocks.add("bulma_footers_empty", {
    label: "Footer Empty",
    content: `
    <footer class="footer">
      <div class="content">
  ...
  editor.Blocks.add("bulma_mediaobj_simple", {
  ...
  editor.Blocks.add("bulma_mediaobj_empty", {
  ...
  editor.Blocks.add("bulma_paginations_centered", {
  ...
  editor.Blocks.add("bulma_paginations_rounded", {
  ...
  editor.Blocks.add("bulma_navbars_transparent", {
  ...
  editor.Blocks.add("bulma_navbars_simple", {
    label: "Navbar Simple",
    content: `
